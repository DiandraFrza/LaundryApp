...
Route::get('/search/pesanan', [AdminController::class, 'searchNoHp'])->name('search.noHp');
...
Route::middleware('role:admin')->group(function () {
    ...
    Route::get('/edit/data/{id}',[AdminController::class,'edit'])->name('edit');
    Route::put('/input/data/{id}',[AdminController::class,'update'])->name('update');
    Route::get('/show',[AdminController::class,'show'])->name('owner');
